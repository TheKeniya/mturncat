...
func main() {
	...
	var username = flag.StringP("username", "u", "", "username (required)")
	var password = flag.StringP("password", "p", "", "password (required)")
	...
	config.Auth.Credentials["username"] = *username
	config.Auth.Credentials["password"] = *password
